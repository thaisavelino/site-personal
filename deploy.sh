...
echo "Welcome '$(hostname -f)' ip: ${MY_IP}" && echo "Pushing work to PROD... $(date)"

echo "Pushing to prod at Branch '${DEPLOY_BRANCH}' of '${DEPLOY_USR_NAME}' project at '${DEPLOY_ROOT_THIS}'"
